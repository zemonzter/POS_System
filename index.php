...
<head>
  ...
  <title>SalesMate | POS System</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="" href="assets/img/LOGO222.png" />
  <!-- Font Awesome -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <center><img width="300 px" src="logo.png"><br>
     <!--<h3><b>FD22 POS   </b>2021</h3> <br><h4>Please Login</h4></center><br>-->
